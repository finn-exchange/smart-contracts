...
contract FINN_Token {
    ...
    function extractFeesFromFinn (address token, address finnContractAddress) public
    {
        uint256 availableBalance = FINN_Base(finnContractAddress).availableBalanceOf(token, this);
        FINN_Base(finnContractAddress).withdraw(token, availableBalance);
